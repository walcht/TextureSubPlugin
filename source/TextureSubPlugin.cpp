...
extern "C" void	UNITY_INTERFACE_EXPORT UNITY_INTERFACE_API SetTextureSubImage2DParams(
	void* texture_handle,
	int32_t xoffset,
	int32_t yoffset,
	int32_t width,
...
extern "C" void UNITY_INTERFACE_EXPORT UNITY_INTERFACE_API SetTextureSubImage3DParams(
	void* texture_handle,
	int32_t xoffset,
	int32_t yoffset,
	int32_t zoffset,
...
static void UNITY_INTERFACE_API OnRenderEvent(int eventID)
{
	...
	case Event::TextureSubImage2D: {
		...
		s_CurrentAPI->TextureSubImage2D(
			...
			g_TextureSubImage2DParams->yoffset,
			g_TextureSubImage2DParams->width,
			g_TextureSubImage2DParams->height,
			g_TextureSubImage2DParams->data_ptr,
			g_TextureSubImage2DParams->level,
			g_TextureSubImage2DParams->format,
			g_TextureSubImage2DParams->type,
	...
	case Event::TextureSubImage3D: {
		...
		s_CurrentAPI->TextureSubImage3D(
			...
			g_TextureSubImage3DParams->zoffset,
			g_TextureSubImage3DParams->width,
			g_TextureSubImage3DParams->height,
			g_TextureSubImage3DParams->depth,
			g_TextureSubImage3DParams->data_ptr,
			g_TextureSubImage3DParams->level,
			g_TextureSubImage3DParams->format,
			g_TextureSubImage3DParams->type,
