...
public:
	...
	/// <summary>
	///		Loads provided data (i.e., sub-region of texture 2D) into a provided texture2D's GPU memory.
	/// </summary>
	/// 
	/// <remarks>
	...
	///		The size in bytes of one row of the source data. Will be provided, as is, to UpdateSubresource's
	///		SrcRowPitch parameter. Only used in case graphics API is Direct3D11.
	/// </param>
	...
	/// <summary>
	///		Callback to process general events like initialization, shutdown, device loss/reset etc.		
	/// </summary>
	/// 
	/// <param name="type">
	/// </param>
